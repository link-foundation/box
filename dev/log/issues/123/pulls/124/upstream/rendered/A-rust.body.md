...
`scripts/check-pipeline-status.sh:69-78` @ `f63a061f`
...
This is a follow-up to [rust#156](https://github.com/link-foundation/rust-ai-driven-development-pipeline-template/issues/156), which added the gate and the supersede test. That issue was right that a cancellation on `main` needs a second question before it can be excused; this one is that the second question has to be asked of the job, not of the run.
