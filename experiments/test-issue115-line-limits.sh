...
CONTRACT_GATE="scripts/ci/check-file-line-limits.sh"
CONTRACT_RC=0
...
printf '%s\n' "$CONTRACT_OUT" | grep -qx -- 'README.md' \
  && pass "and names README.md, which this gate demonstrably reads" \
  || fail "--list-inputs omits README.md"
